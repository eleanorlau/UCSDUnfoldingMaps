...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 50, 50, 350, 500, new Microsoft.RoadProvider());
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, new Microsoft.RoadProvider());

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
		map2.zoomAndPanTo(zoomLevel, new Location(-35.34f, 149.08f));
